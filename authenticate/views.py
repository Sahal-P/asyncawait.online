...
from .authenticate import create_access_token, create_refresh_token, decode_refresh_token, JWTAuthentication, send_email
import pyotp
...
class AdminLoginApiView(APIView):
    ...
    def post(self, request):
        ...
        response = Response()
        response.set_cookie(key='admin_refresh_token', value= refresh_token, httponly = True)
