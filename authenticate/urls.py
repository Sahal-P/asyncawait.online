...
from .views import ( RegisterApiView, LoginApiView, UserAPIView,
     RefreshAPIView, LogOutAPIView, ResetAPIView, ForgotAPIView, 
     AdminLgoinAPIView, AdminLogOutAPIView, TwoFactorAPIView, LoginWithPhoneAPIView, 
     AdminLoginApiView, UsersAPIView )
